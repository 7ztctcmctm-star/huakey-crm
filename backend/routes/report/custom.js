...
// 获取自定义报表列表
router.get('/custom', authenticateToken, checkPermission('report'), async (req, res, next) => {
  try {
...
// 创建自定义报表
router.post('/custom', authenticateToken, checkPermission('report'), validate(customReportSchema), async (req, res, next) => {
  try {
...
// 更新自定义报表
router.put('/custom/:id', authenticateToken, checkPermission('report'), validate(customReportUpdateSchema), async (req, res, next) => {
  try {
...
// 删除自定义报表
router.delete('/custom/:id', authenticateToken, checkPermission('report'), async (req, res, next) => {
  try {
...
// 获取可用字段列表
router.get('/custom/fields/:source', authenticateToken, checkPermission('report'), async (req, res, next) => {
  try {
...
// 执行自定义报表
router.post('/custom/:id/run', authenticateToken, checkPermission('report'), validate(customReportRunSchema), async (req, res, next) => {
  try {
