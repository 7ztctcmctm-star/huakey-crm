...
// 获取备份列表
router.post('/list', authenticateToken, checkPermission('backup:add'), validate(listBackupSchema), async (req, res, next) => {
  try {
...
registry.register('backup', { routes: router, permissions: ['system:backup'] });
