...
.funnel-row { display: flex; padding: 8px 4px; border-bottom: 1px solid var(--color-border); align-items: center; }
.funnel-row:last-child { border-bottom: none; }
.funnel-stage { flex: 1; font-size: 13px; color: var(--color-text-secondary); }
.funnel-count { width: 60px; text-align: right; font-weight: 600; margin-right: 16px; }
.funnel-amount { width: 120px; text-align: right; color: var(--color-text); }
</style>
