...
export const claimCustomer = (id) => request.post('/customer/claim', { customer_id: id })
...
export const forwardCustomer = (data) => request.post('/customer/forward', data)
export const backwardCustomer = (data) => request.post('/customer/backward', data)
// @deprecated 旧转化接口已废弃，请使用 forwardCustomer / backwardCustomer
...
export const convertToCustomer = (id) => request.post('/customer/convert-to-customer', { id })
...
export const getFollowPlanList = (customerId, params = {}) => request.post('/follow-up/plan/list', { customer_id: customerId, ...params })
export const addFollowPlan = (data) => request.post('/follow-up/plan/add', data)
export const completeFollowPlan = (id, data = {}) => request.post('/follow-up/plan/complete', { id, ...data })
export const cancelFollowPlan = (data) => request.post('/follow-up/plan/cancel', data)
