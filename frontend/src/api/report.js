...
// R-05 顶栏筛选：overview / quick-stats / overdue-stats 支持 { startDate, endDate, ownerId }
...
export const getReportSupplierPerformance = (params) => request.get('/report/supplier-performance', { params })
